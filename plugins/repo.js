...
async (conn, mek, m, { from, reply }) => {
    const githubRepoURL = 'https://github.com/Xdetective9/Abdullah-Md.git';
...
> ${config.DESCRIPTION}`;
        ...
        await conn.sendMessage(from, {
            image: { url: config.MENU_IMAGE_URL || 'https://files.catbox.moe/4xj4hv.jpg' },
            ...
            contextInfo: { 
                ...
                forwardedNewsletterMessageInfo: {
                    ...
                    newsletterName: config.OWNER_NAME || 'Abdullah-Md is OnFire!🔥',
                    serverMessageId: 143
                }
            }
        }, { quoted: mek });
        ...
        // Send audio
        await conn.sendMessage(from, {
            audio: { url: 'https://files.catbox.moe/9eduey.mp3' },
            mimetype: 'audio/mp4',
            ptt: true,
            contextInfo: { 
                mentionedJid: [m.sender],
